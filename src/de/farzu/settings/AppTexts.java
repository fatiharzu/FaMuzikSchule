...
public class AppTexts {
    ...
    public static final String LEVEL = "STUFE";
    public static final String RENT_INSTRUMENT = "INSTRUMENT AUSLEIHEN";
    public static final String MSG_RENT_INSTRUMENT = "Instrument ausleihen";
    public static final String MSG_INPUT_ID = "Bitte geben Sie Ihre ID ein";
    ...
    public static final String MSG_NOTE_REGISTRATION_COMPLETED = "Die Registrierung ist abgeschlossen";
    public static final String MSG_SELECT_STD_EDIT = "Bitte geben Sie den Index ein, den Sie ändern möchten!";
